...
class ReceiverState_V2_4_1 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.num_bds_sat = null;
      this.cn0_bds = null;
      this.num_gal_sat = null;
      this.cn0_gal = null;
      this.fix_mode = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('num_bds_sat')) {
        this.num_bds_sat = initObj.num_bds_sat
      }
      else {
        this.num_bds_sat = 0;
      }
      if (initObj.hasOwnProperty('cn0_bds')) {
        this.cn0_bds = initObj.cn0_bds
      }
      else {
        this.cn0_bds = [];
      }
      if (initObj.hasOwnProperty('num_gal_sat')) {
        this.num_gal_sat = initObj.num_gal_sat
      }
      else {
        this.num_gal_sat = 0;
      }
      if (initObj.hasOwnProperty('cn0_gal')) {
        this.cn0_gal = initObj.cn0_gal
      }
      else {
        this.cn0_gal = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [num_bds_sat]
    bufferOffset = _serializer.uint8(obj.num_bds_sat, buffer, bufferOffset);
    // Serialize message field [cn0_bds]
    bufferOffset = _arraySerializer.uint8(obj.cn0_bds, buffer, bufferOffset, null);
    // Serialize message field [num_gal_sat]
    bufferOffset = _serializer.uint8(obj.num_gal_sat, buffer, bufferOffset);
    // Serialize message field [cn0_gal]
    bufferOffset = _arraySerializer.uint8(obj.cn0_gal, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ReceiverState_V2_4_1(null);
    ...
    // Deserialize message field [num_bds_sat]
    data.num_bds_sat = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [cn0_bds]
    data.cn0_bds = _arrayDeserializer.uint8(buffer, bufferOffset, null)
    // Deserialize message field [num_gal_sat]
    data.num_gal_sat = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [cn0_gal]
    data.cn0_gal = _arrayDeserializer.uint8(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += object.cn0_bds.length;
    length += object.cn0_gal.length;
  ...
  static datatype() {
    ...
    return 'piksi_rtk_msgs/ReceiverState_V2_4_1';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'bc31368910e5ef65a7de1c3044300708';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReceiverState_V2_4_1(null);
    ...
    if (msg.num_bds_sat !== undefined) {
      resolved.num_bds_sat = msg.num_bds_sat;
    }
    else {
      resolved.num_bds_sat = 0
    }

    if (msg.cn0_bds !== undefined) {
      resolved.cn0_bds = msg.cn0_bds;
    }
    else {
      resolved.cn0_bds = []
    }

    if (msg.num_gal_sat !== undefined) {
      resolved.num_gal_sat = msg.num_gal_sat;
    }
    else {
      resolved.num_gal_sat = 0
    }

    if (msg.cn0_gal !== undefined) {
      resolved.cn0_gal = msg.cn0_gal;
    }
    else {
      resolved.cn0_gal = []
    }
...
ReceiverState_V2_4_1.Constants = {
...
module.exports = ReceiverState_V2_4_1;
