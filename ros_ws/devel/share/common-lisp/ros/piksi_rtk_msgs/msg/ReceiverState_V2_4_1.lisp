...
;//! \htmlinclude ReceiverState_V2_4_1.msg.html

(cl:defclass <ReceiverState_V2_4_1> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ReceiverState_V2_4_1 (<ReceiverState_V2_4_1>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ReceiverState_V2_4_1>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ReceiverState_V2_4_1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name piksi_rtk_msgs-msg:<ReceiverState_V2_4_1> is deprecated: use piksi_rtk_msgs-msg:ReceiverState_V2_4_1 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod num_sat-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod rtk_mode_fix-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod sat-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod cn0-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod system_error-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod io_error-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod swift_nap_error-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod external_antenna_present-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod num_gps_sat-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod cn0_gps-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod num_sbas_sat-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod cn0_sbas-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod num_glonass_sat-val ((m <ReceiverState_V2_4_1>))
...
(cl:defmethod cn0_glonass-val ((m <ReceiverState_V2_4_1>))
...
(cl:ensure-generic-function 'num_bds_sat-val :lambda-list '(m))
(cl:defmethod num_bds_sat-val ((m <ReceiverState_V2_4_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piksi_rtk_msgs-msg:num_bds_sat-val is deprecated.  Use piksi_rtk_msgs-msg:num_bds_sat instead.")
  (num_bds_sat m))

(cl:ensure-generic-function 'cn0_bds-val :lambda-list '(m))
(cl:defmethod cn0_bds-val ((m <ReceiverState_V2_4_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piksi_rtk_msgs-msg:cn0_bds-val is deprecated.  Use piksi_rtk_msgs-msg:cn0_bds instead.")
  (cn0_bds m))

(cl:ensure-generic-function 'num_gal_sat-val :lambda-list '(m))
(cl:defmethod num_gal_sat-val ((m <ReceiverState_V2_4_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piksi_rtk_msgs-msg:num_gal_sat-val is deprecated.  Use piksi_rtk_msgs-msg:num_gal_sat instead.")
  (num_gal_sat m))

(cl:ensure-generic-function 'cn0_gal-val :lambda-list '(m))
(cl:defmethod cn0_gal-val ((m <ReceiverState_V2_4_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piksi_rtk_msgs-msg:cn0_gal-val is deprecated.  Use piksi_rtk_msgs-msg:cn0_gal instead.")
  (cn0_gal m))

(cl:ensure-generic-function 'fix_mode-val :lambda-list '(m))
(cl:defmethod fix_mode-val ((m <ReceiverState_V2_4_1>))
  ...
  (fix_mode m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ReceiverState_V2_4_1>)))
    "Constants for message type '<ReceiverState_V2_4_1>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ReceiverState_V2_4_1>) ostream)
  "Serializes a message object of type '<ReceiverState_V2_4_1>"
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'num_bds_sat)) ostream)
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'cn0_bds))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:write-byte (cl:ldb (cl:byte 8 0) ele) ostream))
   (cl:slot-value msg 'cn0_bds))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'num_gal_sat)) ostream)
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'cn0_gal))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:write-byte (cl:ldb (cl:byte 8 0) ele) ostream))
   (cl:slot-value msg 'cn0_gal))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ReceiverState_V2_4_1>) istream)
  "Deserializes a message object of type '<ReceiverState_V2_4_1>"
  ...
  (cl:let ((vals (cl:slot-value msg 'cn0_glonass)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:aref vals i)) (cl:read-byte istream)))))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'num_bds_sat)) (cl:read-byte istream))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'cn0_bds) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'cn0_bds)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:aref vals i)) (cl:read-byte istream)))))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'num_gal_sat)) (cl:read-byte istream))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'cn0_gal) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'cn0_gal)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:aref vals i)) (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ReceiverState_V2_4_1>))
  (cl:+ 0
     ...
     1
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'cn0_bds) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 1)))
     1
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'cn0_gal) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 1)))
     4 (cl:length (cl:slot-value msg 'fix_mode))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ReceiverState_V2_4_1>))
  "Converts a ROS message object to a list"
  (cl:list 'ReceiverState_V2_4_1
    ...
    (cl:cons ':num_bds_sat (num_bds_sat msg))
    (cl:cons ':cn0_bds (cn0_bds msg))
    (cl:cons ':num_gal_sat (num_gal_sat msg))
    (cl:cons ':cn0_gal (cn0_gal msg))
