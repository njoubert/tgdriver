...
public:
    ...
    QLabel *label_beidouSatellites_description;
    QLabel *label_beidouSatellites;
    QSpacerItem *horizontalSpacer_16;
    QFrame *line_2;
    QHBoxLayout *horizontalLayout_22;
    QVBoxLayout *verticalLayout_7;
    QLabel *label_beidouStrength_description;
    QLabel *label_beidouStrength_description_unit;
    QSpacerItem *verticalSpacer_6;
    QLabel *label_beidouStrength;
    QSpacerItem *horizontalSpacer_19;
    QFrame *line_10;
    QHBoxLayout *horizontalLayout_23;
    QLabel *label_galileoSatellites_description;
    QLabel *label_galileoSatellites;
    QSpacerItem *horizontalSpacer_20;
    QFrame *line_11;
    QHBoxLayout *horizontalLayout_24;
    QVBoxLayout *verticalLayout_8;
    QLabel *label_galileoStrength_description_unit;
    QLabel *label_galileoStrength_description;
    QSpacerItem *verticalSpacer_7;
    QLabel *label_galileoStrength;
    QSpacerItem *horizontalSpacer_21;
    QFrame *line_12;
    QSpacerItem *verticalSpacer_5;
    QWidget *uartcorrections;
    QHBoxLayout *horizontalLayout_16;
    QGridLayout *gridLayout_5;
    QVBoxLayout *verticalLayout_6;
    QHBoxLayout *horizontalLayout_19;
    QLineEdit *txt_uart;
    QComboBox *cmb_uart_rate;
    QPushButton *btn_uart_start;
    QTextEdit *txt_uart_data;
    QWidget *tab;
    QVBoxLayout *verticalLayout_10;
    QVBoxLayout *verticalLayout_9;
    QHBoxLayout *horizontalLayout_20;
    QPushButton *btn_udp_start;
    QPlainTextEdit *txt_udp_data;
    ...
    void setupUi(QWidget *GpsRtkPlugin)
    {
        ...
        label_beidouSatellites_description = new QLabel(debug);
        label_beidouSatellites_description->setObjectName(QStringLiteral("label_beidouSatellites_description"));
        sizePolicy.setHeightForWidth(label_beidouSatellites_description->sizePolicy().hasHeightForWidth());
        label_beidouSatellites_description->setSizePolicy(sizePolicy);
        label_beidouSatellites_description->setMinimumSize(QSize(121, 21));

        horizontalLayout_21->addWidget(label_beidouSatellites_description);

        label_beidouSatellites = new QLabel(debug);
        label_beidouSatellites->setObjectName(QStringLiteral("label_beidouSatellites"));
        sizePolicy.setHeightForWidth(label_beidouSatellites->sizePolicy().hasHeightForWidth());
        label_beidouSatellites->setSizePolicy(sizePolicy);
        label_beidouSatellites->setMinimumSize(QSize(51, 21));

        horizontalLayout_21->addWidget(label_beidouSatellites);
        ...
        label_beidouStrength_description = new QLabel(debug);
        label_beidouStrength_description->setObjectName(QStringLiteral("label_beidouStrength_description"));
        sizePolicy.setHeightForWidth(label_beidouStrength_description->sizePolicy().hasHeightForWidth());
        label_beidouStrength_description->setSizePolicy(sizePolicy);
        label_beidouStrength_description->setMinimumSize(QSize(111, 21));

        verticalLayout_7->addWidget(label_beidouStrength_description);

        label_beidouStrength_description_unit = new QLabel(debug);
        label_beidouStrength_description_unit->setObjectName(QStringLiteral("label_beidouStrength_description_unit"));
        sizePolicy.setHeightForWidth(label_beidouStrength_description_unit->sizePolicy().hasHeightForWidth());
        label_beidouStrength_description_unit->setSizePolicy(sizePolicy);
        label_beidouStrength_description_unit->setMinimumSize(QSize(81, 21));

        verticalLayout_7->addWidget(label_beidouStrength_description_unit);
        ...
        label_beidouStrength = new QLabel(debug);
        label_beidouStrength->setObjectName(QStringLiteral("label_beidouStrength"));
        label_beidouStrength->setMinimumSize(QSize(0, 21));
        label_beidouStrength->setWordWrap(true);

        horizontalLayout_22->addWidget(label_beidouStrength);
        ...
        label_galileoSatellites_description = new QLabel(debug);
        label_galileoSatellites_description->setObjectName(QStringLiteral("label_galileoSatellites_description"));
        sizePolicy.setHeightForWidth(label_galileoSatellites_description->sizePolicy().hasHeightForWidth());
        label_galileoSatellites_description->setSizePolicy(sizePolicy);
        label_galileoSatellites_description->setMinimumSize(QSize(121, 21));

        horizontalLayout_23->addWidget(label_galileoSatellites_description);

        label_galileoSatellites = new QLabel(debug);
        label_galileoSatellites->setObjectName(QStringLiteral("label_galileoSatellites"));
        label_galileoSatellites->setMinimumSize(QSize(51, 21));

        horizontalLayout_23->addWidget(label_galileoSatellites);
        ...
        label_galileoStrength_description_unit = new QLabel(debug);
        label_galileoStrength_description_unit->setObjectName(QStringLiteral("label_galileoStrength_description_unit"));
        sizePolicy.setHeightForWidth(label_galileoStrength_description_unit->sizePolicy().hasHeightForWidth());
        label_galileoStrength_description_unit->setSizePolicy(sizePolicy);
        label_galileoStrength_description_unit->setMinimumSize(QSize(81, 21));

        verticalLayout_8->addWidget(label_galileoStrength_description_unit);

        label_galileoStrength_description = new QLabel(debug);
        label_galileoStrength_description->setObjectName(QStringLiteral("label_galileoStrength_description"));
        sizePolicy.setHeightForWidth(label_galileoStrength_description->sizePolicy().hasHeightForWidth());
        label_galileoStrength_description->setSizePolicy(sizePolicy);
        label_galileoStrength_description->setMinimumSize(QSize(111, 21));

        verticalLayout_8->addWidget(label_galileoStrength_description);
        ...
        horizontalLayout_24->addLayout(verticalLayout_8);

        label_galileoStrength = new QLabel(debug);
        label_galileoStrength->setObjectName(QStringLiteral("label_galileoStrength"));
        label_galileoStrength->setMinimumSize(QSize(0, 21));
        label_galileoStrength->setWordWrap(true);

        horizontalLayout_24->addWidget(label_galileoStrength);
        ...
        uartcorrections = new QWidget();
        uartcorrections->setObjectName(QStringLiteral("uartcorrections"));
        horizontalLayout_16 = new QHBoxLayout(uartcorrections);
        ...
        txt_uart = new QLineEdit(uartcorrections);
        txt_uart->setObjectName(QStringLiteral("txt_uart"));

        horizontalLayout_19->addWidget(txt_uart);

        cmb_uart_rate = new QComboBox(uartcorrections);
        cmb_uart_rate->setObjectName(QStringLiteral("cmb_uart_rate"));

        horizontalLayout_19->addWidget(cmb_uart_rate);

        btn_uart_start = new QPushButton(uartcorrections);
        btn_uart_start->setObjectName(QStringLiteral("btn_uart_start"));

        horizontalLayout_19->addWidget(btn_uart_start);


        verticalLayout_6->addLayout(horizontalLayout_19);

        txt_uart_data = new QTextEdit(uartcorrections);
        txt_uart_data->setObjectName(QStringLiteral("txt_uart_data"));
        QSizePolicy sizePolicy2(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(txt_uart_data->sizePolicy().hasHeightForWidth());
        txt_uart_data->setSizePolicy(sizePolicy2);
        txt_uart_data->setReadOnly(true);
        txt_uart_data->setOverwriteMode(true);

        verticalLayout_6->addWidget(txt_uart_data);


        gridLayout_5->addLayout(verticalLayout_6, 0, 0, 1, 1);


        horizontalLayout_16->addLayout(gridLayout_5);

        tabWidget->addTab(uartcorrections, QString());
        tab = new QWidget();
        ...
        btn_udp_start = new QPushButton(tab);
        btn_udp_start->setObjectName(QStringLiteral("btn_udp_start"));

        horizontalLayout_20->addWidget(btn_udp_start);


        verticalLayout_9->addLayout(horizontalLayout_20);

        txt_udp_data = new QPlainTextEdit(tab);
        txt_udp_data->setObjectName(QStringLiteral("txt_udp_data"));

        verticalLayout_9->addWidget(txt_udp_data);
    ...
    {
        GpsRtkPlugin->setWindowTitle(QApplication::translate("GpsRtkPlugin", "GpsRtkPlugin", Q_NULLPTR));
        label_nodeStatus_description->setText(QApplication::translate("GpsRtkPlugin", "Last message (UTC):", Q_NULLPTR));
        label_nodeStatus->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_fixType_description->setText(QApplication::translate("GpsRtkPlugin", "Fix type:", Q_NULLPTR));
        label_fixType->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_numSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "Num satellites:", Q_NULLPTR));
        label_numSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_numSatellites_indicator->setText(QString());
        label_numRtkSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "Num satellites (RTK):", Q_NULLPTR));
        label_numRtkSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_numRtkSatellites_indicator->setText(QString());
        label_baseline_description->setText(QApplication::translate("GpsRtkPlugin", "NED baseline [m]:", Q_NULLPTR));
        label_baseline->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_navsatFixAlt_description->setText(QApplication::translate("GpsRtkPlugin", "Navsat fix altitude (avg) [m]:", Q_NULLPTR));
        label_navsatFixAlt->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_numWifiCorrections_description->setText(QApplication::translate("GpsRtkPlugin", "Num Wifi corrections:", Q_NULLPTR));
        label_numWifiCorrections->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_rateWifiCorrections_description->setText(QApplication::translate("GpsRtkPlugin", "Wifi correction rate [Hz]:", Q_NULLPTR));
        label_rateWifiCorrections->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_pingBaseStation_description->setText(QApplication::translate("GpsRtkPlugin", "Base Station ping [ms]:", Q_NULLPTR));
        label_pingBaseStation->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_ageOfCorrections_description->setText(QApplication::translate("GpsRtkPlugin", "Age of Corrections [s]:", Q_NULLPTR));
        label_ageOfCorrections->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(status), QApplication::translate("GpsRtkPlugin", "Status", Q_NULLPTR));
        label_gpsSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "GPS satellites:", Q_NULLPTR));
        label_gpsSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_gpsStrength_description->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>GPS strength:</p></body></html>", Q_NULLPTR));
        label_gpsStrength_description_unit->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>[dB Hz]</p></body></html>", Q_NULLPTR));
        label_gpsStrength->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_sbasSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "SBAS satellites:", Q_NULLPTR));
        label_sbasSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_sbasStrength_description->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>SBAS strength:</p></body></html>", Q_NULLPTR));
        label_sbasStrength_description_unit->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>[dB Hz]</p></body></html>", Q_NULLPTR));
        label_sbasStrength->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_glonassSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "GLONASS satellites:", Q_NULLPTR));
        label_glonassSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_glonassStrength_description->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>GLONASS strength:</p></body></html>", Q_NULLPTR));
        label_glonassStrength_description_unit->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>[dB Hz]</p></body></html>", Q_NULLPTR));
        label_glonassStrength->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_beidouSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "BEIDOU satellites:", Q_NULLPTR));
        label_beidouSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_beidouStrength_description->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>BEIDOU strength:</p></body></html>", Q_NULLPTR));
        label_beidouStrength_description_unit->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>[dB Hz]</p></body></html>", Q_NULLPTR));
        label_beidouStrength->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_galileoSatellites_description->setText(QApplication::translate("GpsRtkPlugin", "GALILEO satellites:", Q_NULLPTR));
        label_galileoSatellites->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        label_galileoStrength_description_unit->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>[dB Hz]</p></body></html>", Q_NULLPTR));
        label_galileoStrength_description->setText(QApplication::translate("GpsRtkPlugin", "<html><head/><body><p>GALILEO strength:</p></body></html>", Q_NULLPTR));
        label_galileoStrength->setText(QApplication::translate("GpsRtkPlugin", "N/A", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(debug), QApplication::translate("GpsRtkPlugin", "Debug", Q_NULLPTR));
#ifndef QT_NO_ACCESSIBILITY
        uartcorrections->setAccessibleName(QString());
#endif // QT_NO_ACCESSIBILITY
        btn_uart_start->setText(QApplication::translate("GpsRtkPlugin", "Start", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(uartcorrections), QApplication::translate("GpsRtkPlugin", "UART Sniffer", Q_NULLPTR));
        btn_udp_start->setText(QApplication::translate("GpsRtkPlugin", "Start", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("GpsRtkPlugin", "UDP Sniffer", Q_NULLPTR));
    } // retranslateUi
